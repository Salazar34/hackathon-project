  ...
  <footer class="py-10">
    ...
    >
      ...
      <div class="links flex flex-col gap-2">
        <h1 class="font-bold pt-10">Link Utili</h1>
        <router-link to="/">Home</router-link>
        <router-link to="/goals">Obbiettivi</router-link>
        <router-link to="/municipality">Comune</router-link>
        <router-link to="/city-security">Sicurezza In Città</router-link>
        <router-link to="/contribute">Contribuisci</router-link>
        <router-link to="/credits">Crediti</router-link>
      </div>
    </div>
  </footer>
</template>
